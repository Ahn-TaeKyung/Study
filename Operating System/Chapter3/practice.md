...
- 부모 프로세스가 먼저 종료한 자식 프로세스
- 종료할 때 종료 코드를 남겨 놓았지만 부모 프로세스가 읽어가지 않고 있을때, 종료한 자식 프로세스
- 입출력 작업이 계산 작업보다 월등히 많은 프로세스
- 계산 작업이 입출력 작업보다 월등히 많은 프로세스
- 사용자와 대화가 필요하지 않고 낮은 우선순위로 실행되는 프로세스
---
